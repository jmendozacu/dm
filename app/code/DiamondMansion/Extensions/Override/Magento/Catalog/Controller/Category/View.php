...
namespace DiamondMansion\Extensions\Override\Magento\Catalog\Controller\Category;
...
class View extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \Magento\Catalog\Model\CategoryRepository\Interceptor $categoryRepository
    ) {
    ...
    public function execute()
    {
        ...
        if ($category) {
            ...
            /** New Category View Layouts */
            $page->addPageLayoutHandles(['mode' => strtolower($category->getDisplayMode())]);            
            /** New Category View Layouts End */
