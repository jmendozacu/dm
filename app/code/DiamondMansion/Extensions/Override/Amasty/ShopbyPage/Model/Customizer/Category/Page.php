...
namespace DiamondMansion\Extensions\Override\Amasty\ShopbyPage\Model\Customizer\Category;
...
class Page extends \Amasty\ShopbyPage\Model\Customizer\Category\Page
{
    /**
        ...
        foreach ($conditions as $condition) {
            ...
            if ($attribute->getId()) {
                ...
                if ($attribute->getFrontendInput() === 'multiselect') {
                    ...
                    if (count(array_diff($condition['value'], $paramValue))) {
                        $isMatched = false;
                        break;
                    }
                } else {
                    if ($paramValue != (is_array($condition['value']) ? $condition['value'][0] : $condition['value'])) {
                        $isMatched = false;
                        break;
                    }
                }
