<?php
namespace DiamondMansion\Extensions\Controller\Adminhtml\Ring\Design\Price\Sidestone;
    ...
    public function execute()
    {
        ...
        foreach($sheetNames as $sheetIndex => $sheetName) {
            ...
            foreach ($sheetData as $row) {
                if (in_array(strtolower($row["A"]), $this->helper->getDesignRingSidestoneColorClarities())) {
