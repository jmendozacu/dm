...
class Crawler
{
    ...
    public function initMultipleCurl(&$pages)
    {
        ...
        foreach ($pages as $key => $page) {
            ...
            $url = $page->getUrl();
            $this->curlList[$url] = $this->request($url, true);
    ...
    protected function request($url, $multiple = false)
    {
        ...
        if ($this->config->isProcessMobile()) {
