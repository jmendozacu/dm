...
class ProductSnippetConfig implements ProductSnippetConfigInterface
{
    ...
    * {@inheritdoc}
    */
    public function getRichSnippetsGtin8Attributes()
    {
        return $this->prepereAttributes($this->scopeConfig->getValue('seo_snippets/product_snippets/gtin8'));
    }

    /**
     * {@inheritdoc}
     */
    public function getRichSnippetsGtin12Attributes()
    {
        return $this->prepereAttributes($this->scopeConfig->getValue('seo_snippets/product_snippets/gtin12'));
    }

    /**
     * {@inheritdoc}
     */
    public function getRichSnippetsGtin13Attributes()
    {
        return $this->prepereAttributes($this->scopeConfig->getValue('seo_snippets/product_snippets/gtin13'));
    }

    /**
     * {@inheritdoc}
     */
    public function getRichSnippetsGtin14Attributes()
    {
        return $this->prepereAttributes($this->scopeConfig->getValue('seo_snippets/product_snippets/gtin14'));
    }
