...
class UpdateMeta extends \Magento\Framework\Model\AbstractModel implements ObserverInterface
{
     ...
     * @param \Mirasvit\Seo\Api\Service\DesignServiceInterface $designService
     */
    ...
    public function modifyHtmlResponseMeta($e, $response = false)
    {
        ...
        if (($this->config->isUseHtmlSymbolsInMetaTags() || $this->designService->isAllowedThemeForUpdateMeta())
