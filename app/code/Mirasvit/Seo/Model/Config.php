...
class Config
{
     ...
     * @return int
     */
    public function getAddressRegionOrganizationSnippets($store)
    {
        return $this->scopeConfig->getValue(
            'seo_snippets/organization_snippets/address_region_organization_snippets',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store
        );
    }
     ...
     * @return string
     */
    public function getManualAddressRegionOrganizationSnippets($store)
    {
        return trim($this->scopeConfig->getValue(
            'seo_snippets/organization_snippets/manual_address_region_organization_snippets',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store
        ));
    }
